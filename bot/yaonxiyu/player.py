...
async def stream(client, m: Message):
    ...
    if not media and not ' ' in m.text:
        await m.reply_text("Reply To An Video To Start Streaming!__")
...
async def not_chat(_, m: Message):
    buttons = [
            ...
            [
                InlineKeyboardButton("🤖 MAKE YOUR OWN BOT 🤖", url="https://heroku.com/deploy?template=https://github.com/Yaonxiyu/Streamgram"),
            ]
         ]
    await m.reply_text(text="**Sorry, You Can't Use This Bot In This Group 🤷‍♂️! But You Can Make Your Own Bot Like This From The [Source Code](https://github.com/Yaonxiyu/Streamgram) Below 😉!**", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
